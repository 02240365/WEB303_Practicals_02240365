...
func (x *SubscribeRequest) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
const file_proto_notification_proto_rawDesc = "" +
	"\n" +
	"\x18proto/notification.proto\x12\fnotification\"N\n" +
	...
	"\ttimestamp\x18\x02 \x01(\tR\ttimestamp2m\n" +
	"\x13NotificationService\x12V\n" +
	"\x16SubscribeNotifications\x12\x1e.notification.SubscribeRequest\x1a\x1a.notification.Notification0\x01B\x1fZ\x1decommerce-microservices/protob\x06proto3"
...
var file_proto_notification_proto_goTypes = []any{
	(*SubscribeRequest)(nil), // 0: notification.SubscribeRequest
	(*Notification)(nil),     // 1: notification.Notification
}
var file_proto_notification_proto_depIdxs = []int32{
	0, // 0: notification.NotificationService.SubscribeNotifications:input_type -> notification.SubscribeRequest
	1, // 1: notification.NotificationService.SubscribeNotifications:output_type -> notification.Notification
