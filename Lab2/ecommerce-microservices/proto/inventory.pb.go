...
const file_proto_inventory_proto_rawDesc = "" +
	...
	"\n" +
	"product_id\x18\x01 \x01(\tR\tproductId\x12\x1a\n" +
	"\bquantity\x18\x02 \x01(\x05R\bquantity2\x9f\x01\n" +
	"\x10InventoryService\x12?\n" +
	"\n" +
	"CheckStock\x12\x17.inventory.StockRequest\x1a\x18.inventory.StockResponse\x12J\n" +
	"\rDecreaseStock\x12\x1f.inventory.DecreaseStockRequest\x1a\x18.inventory.StockResponseB\x1fZ\x1decommerce-microservices/protob\x06proto3"
