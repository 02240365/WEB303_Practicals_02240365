...
type PaymentResponse struct {
	...
	Status        string                 `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"` // e.g. "SUCCESS"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_payment_proto_rawDesc = "" +
	...
	"\x0eProcessPayment\x12\x17.payment.PaymentRequest\x1a\x18.payment.PaymentResponseB\x1fZ\x1decommerce-microservices/protob\x06proto3"
